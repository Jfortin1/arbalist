...
#'
#' @author Natalie Fox
#' @importFrom ggplot2 ggplot aes theme_classic xlab ylab geom_line ggtitle
#' @importFrom SummarizedExperiment colData
#' @export
...
#'
#' @param mae \linkS4class{MultiAssayExperiment} containing a "TileMatrix500" experiment with "Cluster" and "Sample" columns in the colData
#' 
#' @author Natalie Fox
